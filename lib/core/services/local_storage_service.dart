...
class LocalStorageService {
  ...
  Future<void> saveQuote(QuoteModel quote) async {
    try {
      ...
      await prefs.setString(AppConstants.quotesStorageKey, jsonEncode(quotesJson));
    } catch (e) {
  ...
  Future<void> savePreset(PresetModel preset) async {
    try {
      ...
      await prefs.setString(AppConstants.presetsStorageKey, jsonEncode(presetsJson));
    } catch (e) {
  ...
  Future<void> saveSettings(CompanyProfileModel settings) async {
    try {
      await prefs.setString(AppConstants.settingsStorageKey, jsonEncode(settings.toJson()));
    } catch (e) {
